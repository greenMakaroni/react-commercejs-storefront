...
const PaymentForm = ({ onCaptureCheckout, shippingData, checkoutToken, previousStep, nextStep }) => {
                    ...
                    {({ elements, stripe }) => (
                        <form onSubmit={(e) => handleSubmit(e, elements, stripe)}>
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                                <Button variant='outlined' color='secondary' onClick={() => previousStep()}> Edit details </Button>
